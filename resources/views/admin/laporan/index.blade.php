...
<div class="max-w-6xl mx-auto">
    <div class="mb-6">
        ...
        <p class="text-gray-500 text-sm">Rekapitulasi omset berkala untuk validasi data skripsi Wasana Coffee.</p>
    </div>

    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div class="bg-white p-6 rounded-[24px] shadow-xl border border-amber-100 flex items-center justify-between">
            <div>
                <p class="text-xs font-bold text-gray-400 uppercase tracking-wider">Omset Selesai Bulan Ini</p>
                <h3 class="text-2xl font-black text-amber-950 mt-1">Rp {{ number_format($omset_bulan_ini, 0, ',', '.') }}</h3>
            </div>
        ...
        <div class="bg-white p-6 rounded-[24px] shadow-xl border border-amber-100 flex items-center justify-between">
            <div>
                <p class="text-xs font-bold text-gray-400 uppercase tracking-wider">Pesanan Sukses Bulan Ini</p>
                <h3 class="text-2xl font-black text-amber-950 mt-1">{{ $pesanan_selesai_bulan_ini }} Pesanan</h3>
            </div>
